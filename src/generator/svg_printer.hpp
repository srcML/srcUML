 ...
 *
 * \par 
 * The original file can be found [HERE](https://github.com/ogdf/ogdf/blob/master/include/ogdf/fileformats/SvgPrinter.h)
 *
 * \par License:
...
private:
	...
	std::map<std::pair<node, edge>, std::string> m_node_arrow;
